...
import sty from "./PlasmicPrescriptionList.module.css"; // plasmic-import: CQ0vRoErhReQ/css
...
export type PlasmicPrescriptionList__VariantMembers = {
  active: "active";
};
export type PlasmicPrescriptionList__VariantsArgs = {
  active?: SingleBooleanChoiceArg<"active">;
};
type VariantPropType = keyof PlasmicPrescriptionList__VariantsArgs;
export const PlasmicPrescriptionList__VariantProps = new Array<VariantPropType>(
  "active"
);

export type PlasmicPrescriptionList__ArgsType = {};
type ArgPropType = keyof PlasmicPrescriptionList__ArgsType;
export const PlasmicPrescriptionList__ArgProps = new Array<ArgPropType>();

export type PlasmicPrescriptionList__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultPrescriptionListProps {}
...
function PlasmicPrescriptionList__RenderFunc(props: {
  variants: PlasmicPrescriptionList__VariantsArgs;
  args: PlasmicPrescriptionList__ArgsType;
  overrides: PlasmicPrescriptionList__OverridesType;
  forNode?: string;
}) {
    ...
    () => [
      ...
      },
      {
        ...
        initFunc: ({ $props, $state, $queries, $q, $ctx }) =>
          (() => {
            try {
              return $state.apiUserCenterService.data.data[0].can_booking === 1;
            } catch (e) {
              if (
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        {(() => {
          ...
          >
            ...
            <SideEffect
              className={classNames("__wab_instance", sty.sideEffect__hyMp1)}
              deps={(() => {
                try {
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox___6KDyg)}>
                ...
                {(
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__zsHy)}
                    onClick={async event => {
                      const $steps = {};
            ...
            >
              ...
              >
                <Icon36Icon
                  className={classNames(projectcss.all, sty.svg___9WSbo)}
                  onClick={async event => {
                    const $steps = {};
                ...
                <div className={classNames(projectcss.all, sty.freeBox__byWcL)}>
                  ...
                  <Dialog
                    ...
                    trigger={
                      <CalendarIcon
                        className={classNames(projectcss.all, sty.svg___2Lu0R)}
                        role={"img"}
                      />
                    }
                  />
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__sDheN)}>
                <ApiRequest
                ...
                <div className={classNames(projectcss.all, sty.freeBox__nwoZh)}>
                  <div
                    className={classNames(
                      projectcss.all,
                      projectcss.__wab_text,
                  ...
                  <DrCenters
                    ...
                    centers={(() => {
                      try {
                        return $state.apiAllCenters.data.items;
                      } catch (e) {
                        if (
                          e instanceof TypeError ||
                          e?.plasmicType === "PlasmicUndefinedDataError"
                    ...
                    hasAllOption={(() => {
                      try {
                        return $state.apiAllCenters.data.items?.length > 1;
                      } catch (e) {
                        if (
                          e instanceof TypeError ||
                          e?.plasmicType === "PlasmicUndefinedDataError"
                ...
                >
                  <ApiRequest
                    ...
                    onSuccess={async (...eventArgs: any) => {
                      ...
                      (async data => {
                        ...
                        $steps["updateActive"] =
                          $state.apiUserCenterService.data.data[0]
                            .can_booking === 1
                            ? (() => {
                                const actionArgs = {
                                  variable: {
                    ...
                    params={(() => {
                      try {
                        return {
                          user_center_id: $state.apiAllCenters.data.items.find(
                            center => center.id === "5532"
                          ).user_center_id,
                          server_id: 1
                        };
                  ...
                  >
                    <Button
                      children2={
                        <Icon13Icon
                          className={classNames(projectcss.all, sty.svg__jyMlJ)}
                          role={"img"}
                        />
                      }
                      className={classNames(
                        ...
                        sty.button__evOVq,
                        {
                          [sty.buttonactive__evOVquQqFg]: hasVariant(
                            $state,
                            "active",
                            "active"
                          )
                      ...
                      <Switch
                        ...
                        onCheckedChange={async (...eventArgs: any) => {
                          ...
                          (async checked => {
                                  ...
                                  const actionArgs = {
                                    args: [
                                      ...
                                      (() => {
                                        try {
                                          return $state.active
                                            ? "نوبت دهی ویزیت آنلاین در ساعت کاری تعریف شده فعال شد. لطفا در «راس زمان نوبت بیمار» پاسخگو باشید."
                                            : "ویزیت آنلاین شما «غیرفعال» شد. در زمانی که قادر به پاسخگویی به بیماران در راس زمان نوبت‌ بیمار هستید وضعیت ویزیت آنلاین خود را «فعال» کنید.";
                                        } catch (e) {
                                          if (
                                            e instanceof TypeError ||
                            ...
                            if (
                              $steps["onOff"] != null &&
                              typeof $steps["onOff"] === "object" &&
                              typeof $steps["onOff"].then === "function"
                            ) {
                              $steps["onOff"] = await $steps["onOff"];
                            }
                          }).apply(null, eventArgs);
                        }}
                      />
              ...
              {false ? (
                <SideEffect
                  className={classNames(
                    "__wab_instance",
                    sty.sideEffect__tYtPq,
                    {
                      [sty.sideEffectactive__tYtPquQqFg]: hasVariant(
                        $state,
                        "active",
                        "active"
                      )
              ...
              >
                {(() => {
                  ...
                  <Button
                    ...
                    className={classNames("__wab_instance", sty.button__z2S3W)}
                    onClick={async event => {
                      const $steps = {};
                    ...
                    startIcon={
                      <Icon2Icon
                        className={classNames(projectcss.all, sty.svg__hgQzN)}
                        role={"img"}
                      />
                    }
                  />
            ...
            <Dialog
              ...
              body={
                <div className={classNames(projectcss.all, sty.freeBox__x2VgS)}>
                  <AddPatient
              ...
              trigger={
                (
                  ...
                  <Button
                    children2={
                      <Icon2Icon
                        className={classNames(projectcss.all, sty.svg__qUoS5)}
                        role={"img"}
                      />
                    }
                    className={classNames("__wab_instance", sty.button__iaDjv, {
                      [sty.buttonactive__iaDjvuQqFg]: hasVariant(
                        $state,
                        "active",
                        "active"
                      )
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicPrescriptionList__OverridesType,
  DescendantsType<T>
>;
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicPrescriptionList__ArgProps,
          internalVariantPropNames: PlasmicPrescriptionList__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicPrescriptionList__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicPrescriptionList";
  } else {
    func.displayName = `PlasmicPrescriptionList.${nodeName}`;
  }
  return func;
}

export const PlasmicPrescriptionList = Object.assign(
  // Top-level PlasmicPrescriptionList renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicPrescriptionList
    internalVariantProps: PlasmicPrescriptionList__VariantProps,
    internalArgProps: PlasmicPrescriptionList__ArgProps,

    pageMetadata: generateDynamicMetadata(wrapQueriesWithLoadingProxy({}), {
      pagePath: "/book-list-2",
      searchParams: {},
      params: {}
    })
  }
...
export default PlasmicPrescriptionList;
/* prettier-ignore-end */
