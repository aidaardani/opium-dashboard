...
import sty from "./PlasmicButton.module.css"; // plasmic-import: DwD3jMCwWb7c/css
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__iTuNu, {
          [sty.freeBoxcolor_neutral__iTuNuQtq1]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxroundedFull__iTuNUnOgNg]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__iTuNuBaulG]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__iTuNuLoOyW]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__iTuNUpg7U8]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__iTuNut70P]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__iTuNu5Ap8C]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__iTuNu5Ap8CZpwE6]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__z0Bve, {
            [sty.freeBoxcolor_neutral__z0BveQtq1]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__z0BveQtq1YJdzg]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__z0Bveik6Wu]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__z0BveBaulG]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__z0BvEpg7U8]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__z0Bvet70P]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__z0Bve5Ap8C]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___8VxCr)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__iuKbS, {
            [sty.freeBoxiconEnd__iuKbSfdIu]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__iuKbSBaulG]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__iuKbSpg7U8]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__iuKbSt70P]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__kQ0U)}
                role={"img"}
              />
            ),
