...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: q-9PO6DtyMIj/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__lsTqd)}>
        <div className={classNames(projectcss.all, sty.freeBox__lTIn)} />
      </div>
      {renderPlasmicSlot({
