...
import Label from "../../Label"; // plasmic-import: cYqVmJ9Jl1BP/component
import Radio from "../../Radio"; // plasmic-import: q-9PO6DtyMIj/component
import Description from "../../Description"; // plasmic-import: 4tQn60MbmeWF/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: r7HLubnnPtTt/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__xmJsd)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__bLpVw)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__yt4CJ)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__nqsqn)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
