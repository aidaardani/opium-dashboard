...
import sty from "./PlasmicMoshirPaymentSetting.module.css"; // plasmic-import: 98l1eMtaNcgi/css

createPlasmicElementProxy;

export type PlasmicMoshirPaymentSetting__VariantMembers = {
  active: "active";
};
export type PlasmicMoshirPaymentSetting__VariantsArgs = {
  active?: SingleBooleanChoiceArg<"active">;
};
type VariantPropType = keyof PlasmicMoshirPaymentSetting__VariantsArgs;
export const PlasmicMoshirPaymentSetting__VariantProps =
  new Array<VariantPropType>("active");

export type PlasmicMoshirPaymentSetting__ArgsType = {
  userId?: any;
};
type ArgPropType = keyof PlasmicMoshirPaymentSetting__ArgsType;
export const PlasmicMoshirPaymentSetting__ArgProps = new Array<ArgPropType>(
  "userId"
);

export type PlasmicMoshirPaymentSetting__OverridesType = {
  payment?: Flex__<"div">;
  center?: Flex__<"div">;
...
export interface DefaultMoshirPaymentSettingProps {
  userId?: any;
  active?: SingleBooleanChoiceArg<"active">;
  className?: string;
}
...
function PlasmicMoshirPaymentSetting__RenderFunc(props: {
  variants: PlasmicMoshirPaymentSetting__VariantsArgs;
  args: PlasmicMoshirPaymentSetting__ArgsType;
  overrides: PlasmicMoshirPaymentSetting__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={classNames(projectcss.all, sty.freeBox__h0298)}>
          <div className={classNames(projectcss.all, sty.freeBox__p1G2)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
          ...
          {(() => {
            ...
            <ActivationOfficeEditCost
              data-plasmic-name={"activationOfficeEditCost"}
              data-plasmic-override={overrides.activationOfficeEditCost}
              className={classNames(
                "__wab_instance",
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicMoshirPaymentSetting__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    /* Specify args directly as props*/ Omit<
      PlasmicMoshirPaymentSetting__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicMoshirPaymentSetting__ArgProps,
          internalVariantPropNames: PlasmicMoshirPaymentSetting__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicMoshirPaymentSetting__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "payment") {
    func.displayName = "PlasmicMoshirPaymentSetting";
  } else {
    func.displayName = `PlasmicMoshirPaymentSetting.${nodeName}`;
  }
  return func;
}

export const PlasmicMoshirPaymentSetting = Object.assign(
  // Top-level PlasmicMoshirPaymentSetting renders the root element
  makeNodeComponent("payment"),
  {
    ...
    // Metadata about props expected for PlasmicMoshirPaymentSetting
    internalVariantProps: PlasmicMoshirPaymentSetting__VariantProps,
    internalArgProps: PlasmicMoshirPaymentSetting__ArgProps
  }
);

export default PlasmicMoshirPaymentSetting;
/* prettier-ignore-end */
